  ...
  return (
    <section className="pt-12">
      <div className="pt-10 pb-24 shadow-product-card-shadow bg-gradient-to-l from-[#F89358]/[100%] via-[#F893580A]/[4%] to-opacity-25">
        <div className="my-container flex flex-col-reverse md:flex-row items-center justify-between">
          <div className="w-full px-10 md:px-0 md;max-w-[440px]">
            <h1 className="font-bold text-4xl leading-[56px] text-dark-gray mb-11">
              {findData.title} ta'mirlash
            </h1>
            <h4 className="font-medium text-2xl leading-9 tracking-[0.5px] mb-16 md:mb-24 text-dark-gray">
              {findData.text}
            </h4>
