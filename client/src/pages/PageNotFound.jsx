    ...
    return (
        <div className='fixed w-full h-full bg-white top-0 z-[9999] pt-10'>
            <div className="my-container flex flex-col items-center justify-evenly gap-20 relative">
                <img className='absolute bottom-0 right-0 w-32' src={greenLine} alt="greenLine img" />
                <img className='absolute top-0 left-20 w-40' src={orangeLine} alt="orangeLine img" />
                <img className='absolute top-0 right-0 w-10' src={greenLine} alt="greenLine img" />
                <img className='absolute bottom-0 w-20 rotate-90 left-0' src={orangeLine} alt="orangeLine img" />
                <img className='absolute bottom-0 left-1/4 w-40' src={greenLine} alt="greenLine img" />
                <img className='absolute top-20 right-0 w-40' src={orangeLine} alt="orangeLine img" />
