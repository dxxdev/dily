      ...
      <div className="my-container ">
        <div className="pt-30 pb-10  shadow-product-card-shadow px-68 rounded-10 ">
          ...
          <div className="flex items-center justify-center flex-col">
            <button onClick={sliceFunctions} className={`${sliceNumber === 18 ? "block" : "hidden"}`}>
              <img src={union} alt="union" />
            </button>
            <button onClick={closeFunctions} className={`transform rotate-180 ${sliceNumber === 18 ? "hidden" : "block"}`}>
              <img src={union} alt="union" />
            </button>
          </div>
        </div>
